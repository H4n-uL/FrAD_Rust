...
FrAD의 지식재산권은 존재하지 않습니다. FrAD를 구성하는 모든 원본 레포지토리 코드, 기술, 아이디어에 대해서는 특허권, 상표권, 디자인권 등 지식재산권을 주장할 수 없습니다. 다만, 부가기능이나 플러그인을 개발하여 적용한 경우 해당 기능에 한하여 독립적인 지식재산권을 보장합니다.
